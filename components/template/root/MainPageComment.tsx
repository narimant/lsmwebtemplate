import MainCommentSlider from '@/components/module/root/MainCommentSlider';
import React from 'react';

const MainPageComment = () => {
    return (
        <div className='flex container mx-auto mt-12 mb-8 flex-col lg:flex-row'>
            <div className=' flex flex-col items-center  lg:justify-start lg:basis-6/12'>
               <div className='flex justify-between mt-5'>
                <div className='text-slate-600'>
                        <svg className="text-dark-550 lg:ml-4 lg:flex hidden mt-2" width="37" height="34" viewBox="0 0 37 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        <h1 className='text-xl font-bold text-slate-800'>در مورد اوستاشو چه میشنویم؟</h1>
                        <p className='text-slate-600 py-4'>
                        این‌ها، بخش خیلی کوچکی از نظراتی هستند که افراد مختلف در مورد استاد شو دارند.
                        </p>
                    </div>
               </div>
                <div className='flex justify-center items-center mb-5'>
                    <span>
                    <svg className="-rotate-90 lg:rotate-0" width="61" height="25" viewBox="0 0 81 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='  overflow-hidden py-4 px-20 lg:basis-6/12'>
            <MainCommentSlider />
            </div>
        </div>
    );
